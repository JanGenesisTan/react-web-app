...
const ConcessionList = () => {
  ...
  return (
    <div className="concession_header">
      <h2>Concession</h2>
    <div className="concession_grid">
      {concessionListing.map((concession) => (
      <ConcessionCard concession={concession} />
    ))}
    </div>
    </div>
  );
